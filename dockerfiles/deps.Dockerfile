...
RUN set -ex; apt-get update; \
    ...
    cd ~; wget -O openssl.tar.gz "https://www.openssl.org/source/openssl-1.1.1w.tar.gz"; \
    ...
    cd ~; wget -O sqlite.tar.gz https://sqlite.org/2024/sqlite-autoconf-3460000.tar.gz;  \
